...
- Started post-release development; this development line is not covered
  by the `v0.1.0` RECERT decision.
- Deferred subsequent user-usability APIs to separately scoped
  development tasks.
