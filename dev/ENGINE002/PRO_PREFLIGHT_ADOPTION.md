...
| E2-B04 hard LRU and oversized record | lifecycle and benchmark contracts | deterministic charged cache, pinned eviction exclusion, one-plan scratch and planner sub-budgets | 0/below-record/one-record/32-MiB/64-MiB matrix and overflow guards | CLOSED LOCALLY; benchmark RSS audit pending |
...
| E2-B07 authority and benchmark rubric | `ENGINE002_BENCHMARK_CONTRACT.md`, work order sections 16-19 | codec/store benchmark harness | authority 1,974 PASS; 10k/100k harness present | PARTIAL: benchmarks, 2/4-GiB and three-platform gates pending |
